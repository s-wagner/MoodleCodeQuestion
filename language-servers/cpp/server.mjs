...
app2.post('/addcpp', jsonParser, function (req, res) {
    fs.unlink('/tmp/demo.cpp', function (err) {

        fs.appendFile('/tmp/demo.cpp', sanitizeText(req.body.value), function (err2) {
        });
    });
...
server.on('upgrade', (request, socket, head) => {
    ...
    var process1 = exec('./server/clangd --resource-dir /usr/lib/gcc/x86_64-linux-gnu/11/include');
